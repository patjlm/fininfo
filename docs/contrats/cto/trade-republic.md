...
- **Frais — Actions françaises** :
  ...
  - Ordre de 1 000 EUR : 0 EUR (investissement programmé) / 1 EUR sinon
- **Frais — Actions US** :
  - Ordre de 10 EUR : 0 EUR (investissement programmé) / 1 EUR sinon
  - Ordre de 100 EUR : 0 EUR (investissement programmé) / 1 EUR sinon
  - Ordre de 500 EUR : 0 EUR (investissement programmé) / 1 EUR sinon
...
- **Frais — ETF européens** :
  ...
  - Ordre de 500 EUR : 0 EUR (investissement programmé) / 1 EUR sinon
  - Ordre de 1 000 EUR : 0 EUR (investissement programmé) / 1 EUR sinon
- **Frais de change** : aucun sur les ordres — frais de conversion inclus dans les dividendes en devises étrangères (cours acheteur/vendeur avec marge)
- **Frais divers** : aucun (pas de frais de garde, d'inactivité, de retrait ni de transfert sortant)
- **Exemples concrets (scénario mixte)** : 0 EUR avec plans d'investissement programmés ; sinon 3 x 1 + 3 x 1 + 3 x 1 + 3 x 1 = 12 EUR (12 ordres ponctuels)
- **Grille tarifaire complète** : [Trade Republic — Tarification](https://traderepublic.com/fr-fr/tarification)
- **Note frais** : 5/5
...
- **Transfert de compte** : oui — transfert entrant (formulaire à envoyer à l'ancien courtier) et sortant (gratuit, délai ~3 semaines) ; pas de transfert avec changement de titulaire ; pas de transfert de crypto ni de Private Markets
- **IFU fourni** : oui — Imprimé Fiscal Unique conforme à la réglementation française, disponible dans l'application au début de la saison fiscale
- **Déclaration compte étranger** : non nécessaire pour les comptes avec IBAN français (depuis janvier 2025) ; obligatoire (formulaire 3916/3916-bis) pour les anciens comptes avec IBAN allemand
- **Note propriété** : 5/5
...
- **Horaires de négociation** : 7h30 à 23h00
- **Restrictions** : PEA proposé séparément (non inclus dans le CTO) ; pas de SRD ; fractions d'actions uniquement via investissement programmé ou achat par montant
...
- **Test SAV** : réponse très rapide (test sinvestir)
...
- [Trade Republic — Site officiel France](https://traderepublic.com/fr-fr)
- [Trade Republic — Tarification](https://traderepublic.com/fr-fr/tarification)
