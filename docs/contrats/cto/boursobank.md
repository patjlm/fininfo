...
- **Domiciliation du compte** : France (pas de déclaration de compte étranger)
- **Pays disponibles** : France
- **Dépôt initial minimum** : 0 EUR
- **CTO enfant** : non — BoursoBank ne propose pas de compte-titres pour mineur (seuls livrets d'épargne et assurance vie mineur sont disponibles)
...
BoursoBank propose 4 forfaits de courtage pour Euronext (Paris, Bruxelles, Amsterdam) :
...
### Frais par type d'instrument (tarification Découverte)

- **Frais — Actions françaises** :
  - Ordre de 10 EUR : impossible (montant minimum d'achat : 20 EUR pour actions/obligations)
  - Ordre de 100 EUR : 1,99 EUR
  - Ordre de 500 EUR : 1,99 EUR
  - Ordre de 1 000 EUR : 6,00 EUR (0,60 %)
- **Frais — Actions US** :
  - Ordre de 10 EUR : impossible (montant minimum d'achat : 20 EUR)
  - Ordre de 100 EUR : 6,95 EUR
  - Ordre de 500 EUR : 6,95 EUR
  - Ordre de 1 000 EUR : 6,95 EUR
- **Frais — ETF européens** :
...
- **SRD (règlement différé)** : oui — jusqu'à 5x le montant du portefeuille
- **Plateforme de trading** : application mobile et web — streaming temps réel Euronext gratuit, outil « Ma Performance », alertes sur cours (SMS/email), horaires étendus (17h35-22h00 sur 100+ actions et ETF), agrégation de comptes d'autres établissements
- **Note produits** : 3,5/5
...
- **Points faibles** :
  ...
  - Plans d'investissement programmés limités (8 fonds, 0,59 %/an)
...
- [BoursoBank — Compte-Titres Ordinaire](https://www.boursobank.com/bourse/cto-compte-titres-ordinaire)
