...
- **Domiciliation du compte** : Allemagne (déclaration obligatoire comme compte étranger — formulaire 3916/3916-bis)
- **Pays disponibles** : 6 (France, Allemagne, Italie, Espagne, Pays-Bas, Autriche)
...
| Caractéristique | FREE Broker | PRIME+ |
|---|---|---|
...
### Frais par type d'instrument (hors plans d'investissement)

- **Frais — Actions françaises** :
  - Ordre de 10 EUR : 0,99 EUR
  - Ordre de 100 EUR : 0,99 EUR
  - Ordre de 500 EUR : 0,99 EUR (FREE) / 0 EUR (PRIME+)
  - Ordre de 1 000 EUR : 0,99 EUR (FREE) / 0 EUR (PRIME+)
- **Frais — Actions US** :
  - Ordre de 10 EUR : 0,99 EUR
  - Ordre de 100 EUR : 0,99 EUR
  - Ordre de 500 EUR : 0,99 EUR (FREE) / 0 EUR (PRIME+)
...
- **IFU fourni** : non — un rapport fiscal annuel (format allemand) est fourni pour aider à la déclaration, mais pas d'IFU au sens français
- **Déclaration compte étranger** : obligatoire — formulaire 3916/3916-bis (compte domicilié en Allemagne)
- **Protection des dépôts** : 100 000 EUR par client et par établissement (garantie légale des dépôts allemande) ; PRIME+ : répartition sur jusqu'à 5 banques (5 x 100 000 EUR)
- **Note propriété** : 2/5
...
- **Restrictions** : pas de PEA ni PEA-PME ; pas de SRD ; fractions d'actions uniquement via DCA
...
- **Test SAV** : réponse par email en 25h (test sinvestir)
...
- [Scalable Capital — Frais de courtage](https://fr.scalable.capital/frais-courtage)
- [Scalable Capital — Courtier en ligne](https://fr.scalable.capital/en/broker-online)
- [Scalable Capital — Plans d'investissement ETF](https://fr.scalable.capital/plans-investissements-etf)
- [Scalable Capital — Crypto](https://fr.scalable.capital/crypto-monnaies)
- [Scalable Capital — Documentation Client (PDF)](https://fr.scalable.capital/assets/kcbf79ije7q7/4q3LTKoRqVgKXFCk4x5Qb/54a867e3c803600ea57dc97336cf8863/Documentation_Client_20250328.pdf)
