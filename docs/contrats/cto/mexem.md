...
- **Domiciliation du compte** : étranger (Interactive Brokers Ireland Ltd, CBI n° C423427) — déclaration obligatoire comme compte étranger (formulaire 3916)
- **Pays disponibles** : 36
...
- **Frais — Actions US** (0,005 USD par action, min. 1 USD, max. 2 % de la valeur) :
  - Ordre de 10 EUR : 1 EUR
  - Ordre de 100 EUR : 1 EUR
  - Ordre de 500 EUR : 1 EUR
  - Ordre de 1 000 EUR : 1 EUR
- **Frais — ETF européens** (0,06 % min. 1 EUR) :
  - Ordre de 10 EUR : 1 EUR
  - Ordre de 100 EUR : 1 EUR
  - Ordre de 500 EUR : 1 EUR
  - Ordre de 1 000 EUR : 1 EUR
...
- **Frais divers** :
  ...
  - Ordres téléphoniques : gratuit
  - Dividendes : gratuit
- **Exemples concrets (scénario mixte)** : actions US (3 achats + 3 ventes × 1 EUR) + ETF (3 achats + 3 ventes × 1 EUR) = 12 EUR
- **ETF sans commission** : 70 ETF WisdomTree à 0 EUR de frais
- **Grille tarifaire complète** : [MEXEM — Frais](https://fr.mexem.com/fees)
- **Note frais** : 4,5/5
...
- **Transfert de compte** : oui — gratuit
- **IFU fourni** : oui — formulaires fiscaux (2042, 2047, 2074, 2074-CMV, 3916) fournis gratuitement la 1re année si valeur du compte ≥ 2 000 EUR
- **Déclaration compte étranger** : oui — obligatoire chaque année (formulaire 3916)
- **Protection des investisseurs** : Irish Investor Compensation Scheme (ICS) — 90 % du montant perdu, max. 20 000 EUR par investisseur
- **Note propriété** : 5/5
...
- **Restrictions** : ETF US uniquement disponibles pour les clients professionnels
...
- **Test SAV** : quelques secondes d'attente via WhatsApp
...
- **Points forts** :
  ...
  - IFU et formulaires fiscaux français fournis
  - Rémunération des liquidités au taux BCE (> 10 000 EUR)
  - PEA également disponible
- **Points faibles** :
  - Compte étranger : déclaration 3916 obligatoire chaque année
  - Détention des titres en nominee (pas en nom propre)
  - Plateforme TWS complexe pour les débutants (note plateforme : 1/5 selon sinvestir)
  - Pas de CTO enfant/mineur
  - Frais de change avec minimum de 5 EUR
  - Protection limitée à 20 000 EUR (ICS irlandais)
- **Services complémentaires** : PEA, outils d'analyse professionnels, données boursières en temps réel (marchés UE et US), Trader Workstation (TWS), Copy Trading, gestion d'actifs

## Sources

- [S'investir — Comparatif Compte-Titres](https://simulateurs.sinvestir.fr/les-comparateurs/compte-titres)
- [MEXEM — Grille tarifaire](https://fr.mexem.com/fees)
- [MEXEM — Page d'accueil](https://www.mexem.com/)
- [MEXEM — Interactive Brokers](https://www.mexem.com/interactive-brokers-mexem)
- [MEXEM — Régulation et sécurité](https://www.mexem.com/regulations-safety)
- [MEXEM — Marchés accessibles](https://www.mexem.com/exchange-listings)
- [MEXEM — Plan d'épargne (DCA)](https://www.mexem.com/savings-plan)
- [MEXEM — Produits](https://www.mexem.com/products)
- [MEXEM — PEA](https://www.mexem.com/plan-depargne-en-actions)
