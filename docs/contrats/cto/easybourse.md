...
- **Siège** : 49 rue Horace Vernet, 92130 Issy-les-Moulineaux
- **Dépôt initial minimum** : 200 EUR (50 EUR avec la formule EasyStart)
- **CTO enfant** : oui — ouverture possible pour un mineur (livret de famille + formulaire de procuration + pièce d'identité du mandataire requis)
...
EasyBourse propose cinq formules adaptées à différents profils d'investisseurs :

| Caractéristique | EasyStart | EasyDécouverte | EasyPremium | EasyExpert | EasyIntense |
|---|---|---|---|---|---|
...
- **Frais — Actions françaises** :
  ...
  - Ordre de 500 EUR : 2 EUR
  - Ordre de 1 000 EUR : 4,50 EUR (0,45 %)
- **Frais — Actions US** :
  - Ordre de 10 EUR : 6,01 EUR (EasyPremium uniquement)
  - Ordre de 100 EUR : 6,12 EUR
  - Ordre de 500 EUR : 6,60 EUR
  - Ordre de 1 000 EUR : 7,20 EUR
- **Frais — ETF européens** :
  - Ordre de 10 EUR : 2 EUR
  - Ordre de 100 EUR : 2 EUR
...
- **Exemples concrets (scénario mixte)** : actions US (3 x 100 EUR + 3 x 500 EUR) = 36 EUR + frais de change 2,16 EUR = 38,16 EUR ; ETF (3 x 100 EUR + 3 x 500 EUR) = 12 EUR ; total = 50,16 EUR
- **Grille tarifaire complète** : [EasyBourse — Brochure tarifaire (PDF)](https://documents.easybourse.com/formulaires_clients/brochure-tarifaire-bourse.pdf)
- **Note frais** : 2,5/5
...
- **Note globale** : 4,07/5
- **Points forts** :
  - CTO mineur disponible — atout rare sur le marché
  - Filiale de La Banque Postale — solidité et confiance
