...
> Assurance vie distribuée par Linxea, assurée par Generali Vie.
...
- **Gestion UC** : 0,60 % / an
- **Gestion titres vifs** : 0,70 % / an
- **Gestion fonds euros (Netissima / Eurossima)** : 0,75 % / an
- **Gestion fonds croissance (Générations Croiss@nce durable)** : 0,75 % / an
- **Arbitrage** : 0 % en ligne (hors ETF et titres vifs)
- **Arbitrage ETF** : 0 % de frais de transaction
- **Arbitrage titres vifs (actions)** : 0 % de frais de transaction
- **Surcoût gestion pilotée (OTEA ou Carmignac)** : +0,20 % / an sur les UC
- **Frais de rachat** : 0 %
- **Note frais** : 4,75/5
...
- **Fonds disponibles** :
  ...
  - **Eurossima** (garanti à 99,25 % — 100 % possible)
- **Performance 2024** :
  - Eurossima : 1,70 %
  - Netissima : 3,00 % à 3,50 % (bonus +0,50 % si ≥ 50 % en UC)
- **Performance 2025** :
  - Eurossima : 1,67 %
  - Netissima : 3,00 % net de frais de gestion
- **Performance cumulée 5 ans** :
  - Eurossima : 7,42 %
  - Netissima : 11,58 %
- **Offre bonus 2026** : rendement prévisionnel net 4,50 % pour 2026-2027 si minimum 30 % en UC (valable jan-juin 2026)
- **Contraintes d'accès** :
...
- **Private equity** : oui
- **Fonds datés à échéance** : oui — 13 fonds
- **Produits structurés** : oui
- **Fonds croissance** : oui (Générations Croiss@nce durable — garantie partielle à l'échéance)
...
| SCI Capimmo | 0,36 % |
| SCI GF Pierre | 3,53 % |
| SCI Territoires Avenir | 5,03 % |
| SCI Silver Avenir | 0,79 % |
| SCI Perial Euro Carbone | 1,32 % |
| SCI Viagénérations | 2,23 % |
| Linasens | -1,55 % |
| Immo Trend | 2,77 % |
...
- **Points forts** :
  ...
  - Rachat en ligne traité en 72 h
- **Points faibles** :
  - Frais de gestion UC de 0,60 % / an (vs 0,50 % chez Linxea Spirit 2)
  - SCPI : seulement 90 % des loyers reversés (vs 100 % sur Linxea Spirit 2)
  - Contrat de groupe (vs contrat individuel sur Linxea Spirit 2)
  - Netissima limité à 50 % du contrat après le 30/06/2026
  - Pas d'application mobile
  - Solvabilité de Generali Vie non publiée sur la page officielle [à vérifier]
...
- [Linxea — Supports immobiliers Linxea Vie](https://www.linxea.com/assurance-vie/linxea-vie/supports-disponibles-sur-linxea-vie/fonds-immobiliers-linxea-vie/)
- [Linxea — Documentation Linxea Vie clients](https://www.linxea.com/documentation/linxea-vie-clients/)
