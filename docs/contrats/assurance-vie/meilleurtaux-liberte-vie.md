...
> Assurance vie distribuée par Meilleurtaux Placement, assurée par Spirica (filiale à 100 % de Crédit Agricole Assurances).
...
- **Modes de gestion** : Libre, pilotée (Marc Fiorentino et son comité d'experts), mixte
...
- **Fonds Euro Objectif Climat** : garanti à 98 % — 100 % possible — accessible uniquement par versement (pas par arbitrage)
...
- **Versements programmés minimum** : 100 EUR / mois ou par trimestre (minimum 50 EUR par support)
- **Arbitrage minimum** : 500 EUR ou la totalité du support
- **Règles d'arbitrage** :
...
- **Conditions gestion pilotée** :
  - Gestionnaire : Marc Fiorentino et son comité d'experts
  - 4 profils : Prudent, Équilibré, Dynamique, Audacieux
  - Surcoût : 0,40 % / an (Prudent, Équilibré, Dynamique) — 0,50 % / an (Audacieux)
  - Gestion mixte possible (combinaison libre + pilotée)
- **Rachat partiel minimum** : 500 EUR
- **Rachat instantané en ligne** : limité à 60 % de l'encours et à 20 000 EUR / trimestre
...
- **App mobile** : oui
- **Contact** : téléphone (01 47 20 33 00), email (placement@meilleurtaux.com), formulaire de contact, chat, 7 agences en France
...
- **Points faibles** :
  - Frais de gestion pilotée plus élevés que chez certains concurrents (0,40-0,50 % de surcoût)
