...
- **Rachat partiel minimum** : 500 EUR (ponctuel) — 150 EUR (programmé)
- **Avance sur contrat** : disponible (pour financer un besoin momentané, avec intérêts) — conditions précises dans le règlement général des avances
...
- **Points forts** :
  ...
  - Fonds Croissance avec garantie 100 % du capital net de frais de gestion à 10 ans
...
- **Points faibles** :
  - 10 % de frais de performance sur le Fonds Croissance
  - Frais de gestion fonds euros à 0,70 % / an
