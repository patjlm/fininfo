...
> Assurance vie distribuée par Louve Invest, assurée par Corum Life (groupe Corum).
...
- **Arbitrage** : 0 %
- **Surcoût gestion pilotée** : 0,21 % / an supplémentaires
- **Frais de rachat** : 0 %
- **Frais de transaction ETF** : 0,10 % par transaction
- **Frais SCPI** : frais de souscription identiques à l'achat en direct (jusqu'à ~12 %), prélevés au moment du retrait des parts — non prélevés à l'entrée
...
| Nom | ISIN | TER |
|---|---|---|
| Amundi S&P 500 II UCITS ETF Acc | LU1135865084 | 0,05 % |
| Amundi Nasdaq-100 II UCITS ETF Acc | LU1829221024 | 0,22 % |
| Amundi CAC 40 UCITS ETF Acc | FR0013380607 | 0,25 % |
| Amundi EURO STOXX 50 UCITS ETF | LU1681047236 | 0,09 % |
| Amundi Stoxx Europe 600 UCITS ETF Acc | LU0908500753 | 0,07 % |
| Amundi MSCI World UCITS ETF Acc | IE000BI8OT95 | 0,12 % |
| Amundi MSCI Emerging Markets UCITS ETF Acc | LU2573967036 | 0,14 % |
| Amundi Smart Overnight Return UCITS ETF Acc (monétaire) | LU1190417599 | 0,10 % |
...
- **Règles d'arbitrage** : 0 % de frais d'arbitrage en ligne
...
- **Points faibles** :
  - Versement initial élevé : 5 000 EUR minimum
  - Fonds euros limité à 10 % — contrat inadapté aux profils prudents
  - SCPI limitées à 55 % du contrat
  - Frais de souscription SCPI prélevés au retrait (identiques à l'achat en direct)
  - Pas d'application mobile
  - Univers UC limité : 20 supports seulement (pas de titres vifs, pas de OPCI/SCI)
  - Pas de rééquilibrage automatique
- **Services complémentaires** : SCPI en courtage direct (spécialité de Louve Invest)
