...
> Assurance vie distribuée par Bourse Direct, assurée par Generali Vie.
...
- **Assureur** : Generali Vie
- **Type** : Multisupports (contrat groupé, adhésion individuelle facultative)
- **Modes de gestion** : Libre, pilotée (mandatée par DNCA)
- **Disponibilité** : En ligne et en agence (4 agences en France)
...
- **Gestion fonds euros** : 0,75 % / an
- **Arbitrage** : 0 %
- **Surcoût gestion pilotée** : + 0,20 % / an sur les UC (0,85 % total vs 0,65 % en gestion libre) — frais des fonds sélectionnés généralement élevés
- **Frais de rachat** : 0 %
- **Autres frais** : frais propres aux supports UC (frais courants des fonds)
...
- **Fonds disponibles** :
  ...
  - Netissima (garanti à 100 % — 50 % max du contrat)
- **Performance 2024** :
  - Eurossima : 1,70 %
  - Netissima : 3,00 % à 3,50 %
- **Performance 2025** :
  - Eurossima : 1,67 %
  - Netissima : 3,00 %
...
- **ETF** : 149
- **SCPI** : 0 (aucune SCPI disponible dans ce contrat)
- **Titres vifs** : oui — 103 actions (CAC 40, SBF 120)
- **Rééquilibrage automatique** : oui
- **Autres supports** :
  - 306 fonds actions
  - 86 fonds obligataires
  - ETN cryptomonnaies
...
- **Limites d'investissement** :
  - Netissima : 50 % max du contrat
  - Eurossima : 50 000 EUR max l'année d'adhésion, puis 25 000 EUR / an les années suivantes
  - Titres vifs : disponibles à partir de 1 500 EUR par ligne [à vérifier]
- **Conditions gestion pilotée** :
  - Mandatée par DNCA Finance
  - Profil Modéré : objectif 20 % actions
...
- [Bourse Direct — Assurance Vie](https://www.boursedirect.fr/fr/assurance-vie)
- [Bourse Direct — Bourse Direct Horizon](https://www.boursedirect.fr/fr/assurance-vie/bourse-direct-horizon)
- [Bourse Direct — Liste des supports UC](https://www.boursedirect.fr/fr/assurance-vie/liste-des-supports-bourse-direct-horizon)
