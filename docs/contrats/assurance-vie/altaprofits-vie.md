...
> Assurance vie distribuée par Altaprofits, assurée par Generali Vie (Groupe Generali).
...
- **Type** : Multisupports
- **Modes de gestion** : Libre, pilotée (11 profils via Lazard Frères Gestion et Generali Wealth Solutions)
...
- **Gestion UC ETF** : 0,60 % + 0,10 % / an = 0,70 % (contrat < 300 000 EUR) — 0,45 % + 0,10 % / an = 0,55 % (contrat ≥ 300 000 EUR)
- **Gestion UC titres vifs** : 0,60 % + 0,10 % / an = 0,70 % (contrat < 300 000 EUR)
...
- [Altaprofits — Page produit Altaprofits Vie](https://www.altaprofits.com/assurance-vie/assurance-vie-generali)
- [Altaprofits — Supports d'investissement gestion libre](https://www.altaprofits.com/supports-d-investissement/gestion-libre)
- [Altaprofits — Page assurance vie](https://www.altaprofits.com/assurance-vie)
- [Generali France — Site institutionnel](https://www.generali.fr)
