...
frais-versement: "0 %"
frais-gestion-uc: "0,60 % (gestion libre) / 1,30 % (mandat d'arbitrage)"
frais-arbitrage: "0 %"
...
> Assurance vie distribuée par Yomoni, assurée par Suravenir (filiale du Crédit Mutuel Arkea).
...
- **Distributeur** : Yomoni (robo-advisor français, 80 000+ clients, 2+ Md€ sous gestion, certifié B Corp)
- **Assureur** : Suravenir (filiale du Crédit Mutuel Arkea)
- **Type** : Multisupports, contrat de groupe n°3185
- **Modes de gestion** : Mandat d'arbitrage (gestion pilotée, 1 000 EUR minimum par compartiment) / Gestion libre (Offre Yomoni Gestion Privée, 50 000 EUR minimum)
- **Disponibilité** : En ligne exclusivement
- **Versement initial minimum** : 1 000 EUR
- **Année de création** : 2015
- **Souscripteur du contrat groupe** : Althéis (sous la marque Yomoni), SIREN 811 266 170, 231 rue Saint-Honoré, 75001 Paris
...
- **Gestion UC — mandat d'arbitrage** : 1,30 % / an (inclut le surcoût de 0,70 % pour la gestion pilotée)
- **Gestion fonds euros — gestion libre** :
  - Suravenir Rendement 2 : 0,60 % / an
  - Suravenir Opportunités 2 : 3,00 % maximum / an
- **Gestion fonds euros — mandat d'arbitrage** :
  - Suravenir Rendement et Suravenir Rendement 2 : 0,60 % / an
- **Arbitrage** : 0 % (opérations entre supports, hors arbitrages du mandat)
- **Frais ETF internes** : environ 0,30 % / an (soit ~1,60 % total all-in en mandat d'arbitrage)
- **Frais de rachat** : 0 %
- **Frais de rente** : 3 % sur quittances d'arrérages
- **Remise de titres** : 1 % des fonds gérés en cas de rachat total, décès ou terme (option)
- **Garantie décès accidentelle (optionnelle)** : majoration FAG de 0,14 % / an + prime mensuelle de 0,15 ‰ à 5,15 ‰ des capitaux sous risque selon l'âge
...
- **Nombre total d'UC** : 203 (source : sinvestir.fr)
- **ETF** : 145
- **SCPI** : 0 (pas de SCPI en direct)
- **SCI/Immobilier** : SC Y Immo (FR001400HPS4) — 1 UC immobilière
- **OPCVM Yomoni** : Yomoni Allocation (FR0013329786), Yomoni Monde (FR0013329778), Yomoni Monde PEA (FR0014002RL1)
- **Titres vifs** : non
- **Private equity** : accessible via Offre Yomoni Gestion Privée (gestion libre, 50 000 EUR minimum)
- **Produits structurés** : accessibles via Offre Yomoni Gestion Privée
- **ESG** : versions ESG disponibles pour tous les profils de mandat d'arbitrage
- **Options d'arbitrages programmés** (gestion libre uniquement) : rééquilibrage automatique, investissement progressif, sécurisation des plus-values, stop-loss relatif, dynamisation des plus-values
- **Valorisation ETF** : cours de clôture quotidien
- **Note UC** : 3/5 (source : sinvestir.fr)

### Sélection de supports ETF disponibles
<!-- Mis à jour : 2026-05-26 -->
...
| ISIN | Nom | Catégorie |
|---|---|---|
| FR0013329786 | Yomoni Allocation | Allocation diversifiée |
| FR0013329778 | Yomoni Monde | Actions Monde |
| FR0014002RL1 | Yomoni Monde PEA | Actions Monde |
...
### Versements
- **Versement initial minimum** : 1 000 EUR
- **Versements libres minimum** : 50 EUR (50 EUR par support en gestion libre ; 1 000 EUR par compartiment en mandat d'arbitrage)
- **Versements programmés minimum** : 50 EUR/mois, 50 EUR/trimestre, 50 EUR/semestre, 50 EUR/an (50 EUR minimum par compartiment, 50 EUR par support en gestion libre)
- **Ajustement automatique des versements programmés** : disponible (évolution annuelle selon indice communiqué)

### Arbitrages
- **Arbitrage minimum** : 50 EUR (désinvestissement et réinvestissement)
- **Solde minimum après arbitrage** : 100 EUR sur le compartiment (gestion libre et mandat d'arbitrage) ; 50 EUR par support en gestion libre
- **Suravenir Opportunités 2** : inéligible aux arbitrages — accessible uniquement par versement lors des périodes d'ouverture
- **Mandat d'arbitrage** : arbitrages réalisés par Althéis/Yomoni en nom et pour le compte du client ; le client ne sélectionne pas lui-même les supports ; arbitrages minimum de 20 EUR déclenchés par le mandat
- **Délai arbitrage (en ligne, jours ouvrés avant 23h)** : effet le 1er jour ouvré suivant la saisie

### Rachats
- **Rachat partiel minimum** : 100 EUR (50 EUR minimum par support en gestion libre)
- **Solde minimum après rachat** : 100 EUR sur le contrat, 100 EUR par compartiment, 50 EUR par support en gestion libre
- **Délai de règlement** : 30 jours à compter de la réception des pièces par Suravenir
- **Rachats partiels programmés** : disponibles (mensuel/trimestriel/semestriel/annuel, minimum 100 EUR ; valeur de rachat minimum 1 000 EUR sur le contrat ; incompatibles avec avance en cours ou versements programmés)

### Avance sur contrat
- **Avance** : possible sous réserve de l'accord de Suravenir ; modalités et tarification sur simple demande
...
- Gestion 100 % ETF ou multi-actifs selon les profils
- Un seul profil actif par compartiment
- Encours minimum par compartiment en mandat : 1 000 EUR
- Frais tout compris : 1,30 % / an UC (hors frais internes ETF ≈ 0,30 %) soit ~1,60 % all-in

### Gestion libre
- Accessible via Offre Yomoni Gestion Privée (50 000 EUR minimum)
- Sélection autonome parmi les UC disponibles
- Options d'arbitrages programmés disponibles (rééquilibrage automatique, investissement progressif, sécurisation des plus-values, stop-loss relatif, dynamisation des plus-values)

### Multi-compartiments
- Possibilité d'ouvrir plusieurs compartiments (gestion libre et/ou mandat d'arbitrage)
- Versement libre à positionner sur un seul compartiment
- Versements programmés initiaux sur un seul compartiment ; plusieurs compartiments possibles en cours de vie

### Conversion en rente
- Possible avant 85 ans
- Options : réversion, annuités garanties, rentes par paliers croissants/décroissants, garantie dépendance
- Frais : 3 % sur quittances d'arrérages

### Autres
- **Clause bénéficiaire** : standard / libre (100 % en ligne)
- **Assurance-vie enfant** : disponible
...
- **Protection** : Fonds de Garantie des Assurances de Personnes (FGAP) jusqu'à 70 000 EUR par bénéficiaire par contrat

## Expérience client
<!-- Mis à jour : 2026-05-26 -->

- **Avis clients** : 4,8/5 (3 897 avis — source : sinvestir.fr)
- **App mobile** : oui
- **Contact** : téléphone (01 75 85 97 47), email (hello@yomoni.fr)
- **Chat** : non
- **Courrier** : non
- **Ergonomie** : très bonne ergonomie et intuitive (source : sinvestir.fr)
...
- **Points faibles** :
  - Gestion libre (Offre Gestion Privée) accessible uniquement à partir de 50 000 EUR
