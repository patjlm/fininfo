...
assureur: Apicil
frais-versement: "0 %"
frais-gestion-uc: "0,60 % (assureur Apicil) + 0,60 % (gestion déléguée Caravel)"
frais-arbitrage: "0 %"
...
- **Versement** : 0 %
- **Gestion UC (assureur Apicil)** : 0,60 % / an
- **Gestion déléguée (Caravel)** : 0,60 % / an
- **Gestion fonds euros** : 0,72 % / an (inclus dans le 0,60 % assureur — non applicable en mode gestion déléguée pure ETF)
- **Arbitrage** : 0 %
- **Rente (arrérage)** : 1,50 %
- **Frais des supports financiers (ETF)** : 0,16 % à 0,18 % selon le profil
- **Total tout compris** : 1,36 % à 1,38 % / an (confirmé sur getcaravel.fr/tarifs)
- **Frais associatifs (GERP)** : 8 EUR / an
- **Options payantes (facultatives)** :
  - Stop Loss : 0,20 % des sommes arbitrées (min 100 EUR)
  - Écrêtage des plus-values : 0,20 % des sommes arbitrées (min 100 EUR)
  - Lissage des investissements : 0 %
- **Transfert entrant** : 0 %
...
- **Nombre total d'UC** : + 700 (selon sinvestir) — le site officiel ne détaille pas la liste complète
...
- **Versement initial minimum** : 500 EUR (confirmé sur getcaravel.fr)
...
- **Transfert sortant** : 1 % si contrat < 5 ans, gratuit après 5 ans (confirmé sur getcaravel.fr/tarifs)
...
- **Points faibles** :
  - Pas de gestion libre : impossible de choisir ses supports individuellement (uniquement gestion déléguée)
