...
nom: Yomoni Retraite+
type: contrat-per
slug: yomoni-retraite-plus
distributeur: Yomoni
assureur: Spirica (filiale du Crédit Agricole Assurances)
frais-versement: "0 %"
frais-gestion-uc: "0,30 % (0,50 % max contractuel)"
frais-arbitrage: "0 %"
...
> PER assurantiel distribué par Yomoni, assuré par Spirica. Contrat d'assurance-vie de groupe multisupport souscrit par l'Association Retraite Falguière.

## Informations générales
<!-- Mis à jour : 2026-05-26 -->

- **Distributeur** : Yomoni
- **Assureur** : Spirica — filiale du Crédit Agricole Assurances (solvabilité : 151,6 %)
- **Type** : Assurantiel
- **Modes de gestion** : gestion pilotée à horizon, gestion pilotée à désensibilisation, gestion sous mandat pilotée, gestion libre (contractuellement disponible mais non mise en avant commercialement)
- **Disponibilité** : 100 % en ligne
- **Versement minimum** : 1 000 EUR
- **Année de création** : 2023 (lancé le 9 octobre 2023)
- **Adhésion** : réservée aux membres de l'Association Retraite Falguière (résidents France métropolitaine ou DOM)
- **Frais d'adhésion** : 10 EUR (association Retraite Falguière) — promotion en cours : 0 EUR affiché sur le site
...
- **Arbitrage** : 0 % (entre modes de gestion, entre profils, en gestion libre, en gestion sous mandat pilotée)
...
- **Frais de transfert sortant** : 1 % maximum si < 5 ans depuis l'adhésion, 0 % après 5 ans
- **Note frais** : 3/5

## Fonds euros
<!-- Mis à jour : 2026-05-26 -->

- **Fonds disponible** : Fonds Euro PER Nouvelle Génération (garantie 98 % — accessible jusqu'à 100 % du contrat)
- **Performance 2024** : 3,13 %
- **Performance 2025** : 3,08 %
- **Performance cumulée 5 ans** : 13,29 %
- **Plafond** : 5 millions EUR tous contrats Spirica confondus
- **Contraintes d'accès** : en gestion pilotée, l'allocation est déterminée par le profil choisi ; en gestion libre, l'épargnant peut y investir directement
- **Frais de gestion** : 2 % maximum/an (source : CGV)
- **Composition (31/12/2024)** : obligations 56 %, immobilier 32 %, monétaire 7 %, non coté 3 %, actions 2 %
- **Note fonds euros** : 5/5

## Unités de compte
<!-- Mis à jour : 2026-05-26 -->

- **Nombre total d'UC** : choix restreint en gestion pilotée ; plus large en gestion libre (voir fiche Spirica pour la liste complète)
- **ETF** : Yomoni Monde ISR, Yomoni Allocation ISR (gestion pilotée) ; ETF individuels en gestion libre
- **SCPI** : non disponible directement
- **Immobilier** : SC Y Immo (société civile immobilière, gérée par Épopée Gestion, anciennement Keys REIM)
- **Private Equity** : FCPR APEO (labellisé Relance)
- **Support Croissance Allocation Long Terme** : accessible uniquement en gestion libre (frais 1 % + commission de performance 10 % sur performance positive)
- **Titres vifs** : non
- **Rééquilibrage automatique** : oui (en gestion pilotée)
- **Autres supports** : fonds ISR (Investissement Socialement Responsable)
- **Note UC** : 3,5/5

## Conditions et contraintes spécifiques
<!-- Mis à jour : 2026-05-26 -->
<!-- Source : CGV CG9410 - 01/11/2023 (Spirica) -->
<!-- Source : https://www.yomoni.fr/transfert-per -->

### Versements

- **Versement initial minimum** :
  - 1 000 EUR quel que soit le mode de gestion
- **Versements libres minimum** :
  - 100 EUR en gestion libre (affectation min. 50 EUR par support)
  - 1 000 EUR sur un nouveau profil de gestion pilotée à horizon ou sous mandat
  - 500 EUR sur un profil de gestion sous mandat déjà investi
- **Versements libres programmés minimum** :
  - 50 EUR / mois (ou trimestre, semestre, an) en gestion libre

### Modes de gestion

- **Gestion pilotée à horizon** (mode par défaut) : Spirica gère l'allocation selon un profil parmi 3 (multi-actifs prudent, équilibré, dynamique) avec désensibilisation réglementaire progressive
- **Gestion pilotée à désensibilisation** : Spirica gère avec désensibilisation selon 3 profils ETF (ETF prudent, équilibré, dynamique à désensibilisation) — uniquement sur UC ETF, pas de fonds euros
- **Gestion sous mandat pilotée** : un mandataire (Yomoni) sélectionne les supports pour le compte de l'épargnant
- **Gestion libre** : l'épargnant choisit lui-même ses supports (fonds euros, UC, support Croissance Allocation Long Terme) — pas de désensibilisation automatique

### Arbitrages

- **Arbitrages** : gratuits dans tous les modes de gestion
- **Arbitrage auto** : l'épargnant ne peut pas réaliser lui-même d'arbitrages sur l'épargne en gestion pilotée à horizon ou sous mandat — seul le changement de profil / mode est possible
- **Changement de profil / mode** : à tout moment, gratuit

### Sortie en capital

- **Sortie unique** : capital total en une fois
- **Sortie fractionnée libre** : à tout moment, minimum 1 000 EUR par retrait, solde minimum 1 000 EUR
- **Sortie fractionnée programmée** : périodicité choisie, minimum 150 EUR/mois, 450 EUR/trimestre, 900 EUR/semestre, 1 800 EUR/an

### Options de rente

- **Rente viagère simple**
- **Rente viagère réversible** : taux de réversion de 50 % à 150 % (par tranches de 10 %)
- **Rente à annuités garanties** : nombre d'annuités limité à l'espérance de vie diminuée de 5 ans
- **Rente réversible à annuités garanties** (deux bénéficiaires : 1er et 2e rang, réversion 50 % à 100 %)
- **Rente à paliers** : 2 majorations ou diminutions maximum, chacune sur 10 ans
- **Périodicité** : mensuelle, trimestrielle, semestrielle ou annuelle
- **Frais sur arrérages de rente** : 0 %
- **Frais support de rente** : 2 % max/an

### Transferts

- **Transfert entrant** : 0 % de frais — promotion : remboursement 100 % des frais de transfert avec code TRANSFERTPER jusqu'au 30 juin 2026
...
- **Yomoni Retraite+** (assurantiel, lancé 2023) : multi-actifs (ETF + fonds euros + immobilier + Private Equity), assuré par Spirica, garantie FGAP 70 000 EUR, avantages successoraux de l'assurance-vie

## Supports utilisés en gestion pilotée
<!-- Mis à jour : 2026-05-26 -->
<!-- Source : https://www.yomoni.fr/legal/supports-investissement -->
<!-- Source : https://blog.yomoni.fr/yomoni-lance-yomoni-retraite-un-per-assurantiel-multi-actifs-etf-fonds-en-euros-immobilier-non-cote-en-gestion-pilotee-responsable/ -->

> En gestion pilotée, l'épargnant ne choisit pas individuellement les supports.
> Deux enveloppes disponibles : multi-actifs (ETF + fonds euros + immobilier + Private Equity) ou ETF pur.
> Trois profils de risque : prudent, équilibré, dynamique.
> La gestion libre donne accès à un univers plus large défini dans l'Annexe Financière du contrat.

### Supports principaux

| Nom | ISIN | Type | Catégorie |
|---|---|---|---|
| Fonds Euro PER Nouvelle Génération | — | Fonds euros | Obligations diversifiées (garantie 98 %) |
| Yomoni Monde ISR P | FR0050000290 | SICAV (fonds d'ETF) | Actions internationales |
| Yomoni Allocation ISR S | FR001400KC73 | SICAV (fonds d'ETF) | Allocation flexible internationale |
| SC Y Immo | FR001400HPS4 | SC (société civile) | Immobilier diversifié ISR |
| FCPR APEO | FR0013533619 | FCPR | Private Equity (LBO / capital-développement) |

- **Yomoni Monde ISR** : indice de référence 50 % MSCI ACWI NR EUR + 50 % MSCI ACWI 100 % Hdg NR EUR — composé d'une quinzaine d'ETF ISR (article 8, Paris-Aligned)
- **Yomoni Allocation ISR** : indice composite 50 % Bloomberg Euro Aggregate + 25 % MSCI ACWI NR EUR + 25 % MSCI ACWI Hdg NR EUR — allocation flexible actions/obligations
- **SC Y Immo** : gestion déléguée à Épopée Gestion (anciennement Keys REIM) — label ISR, 95 % immobilier / 5 % poche liquidité
- **FCPR APEO** : géré par Seven2 (anciennement Apax Partners) — label Relance, 90 % LBO + 10 % capital-développement, durée 99 ans
- **Fonds Euro PER Nouvelle Génération** : pas d'ISIN (actif général de l'assureur Spirica) — allocation cible 70 % obligations / 30 % diversifié

### ETF sous-jacents des fonds Yomoni (composition indicative)

> La composition exacte évolue au gré des réallocations de l'équipe de gestion.
...
- **Ergonomie** : très bonne, interface intuitive
- **Note SAV** : 4,4/5
