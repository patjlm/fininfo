...
- **Type** : Assurantiel (contrat de groupe souscrit par l'APACTE)
- **Modes de gestion** : libre, pilotée sous mandat, évolutive (Horizon Retraite), mixte (cumul possible)
...
- **Gestion sous mandat** : 0,80 %/an (soit 0,20 % de surcoût vs gestion libre)
- **Arbitrage** : 0 % (gratuits et illimités)
...
- **Performance 2025** : 2,96 % (net de frais de gestion, brut de prélèvements sociaux)
- **Performance cumulée 5 ans** : 11,93 %
- **Contraintes d'accès** : aucune — 100 % fonds euros possible
- **Table de mortalité** : garantie à l'adhésion (avantage pour la sortie en rente)
...
- **Versements programmés minimum** : 50 EUR/mois, 150 EUR/trimestre, 150 EUR/semestre ou 150 EUR/an (plafond 1 500 EUR/mois)
- **Modification versements programmés** : possible à tout moment (suspension, augmentation, diminution)

### Arbitrages

- **Arbitrage minimum** : Non communiqué
- **Frais d'arbitrage** : 0 % (gratuits et illimités)
- **Frais ETF** : 0,10 % à l'investissement et au désinvestissement
- **Frais supports immobiliers** : 0 % à 2,95 % selon le support
- **Options d'arbitrage automatique** : non disponibles sur le PER (disponibles uniquement sur le contrat assurance-vie Lucya Abeille, à partir de 2 000 EUR de valorisation)

### Limites d'investissement

- **SCPI** : aucune SCPI disponible — seuls les supports SC, SCP et OPCI sont accessibles
...
- **Profils** : Modéré, Équilibré, Dynamique (3 profils)
- **Minimum** : sans minimum spécifique [à vérifier]
- **Investissement** : 100 % en UC
- **Changement de profil** : gratuit, à tout moment

### Gestion évolutive — Horizon Retraite

- **Frais de gestion** : 0,60 %/an (pas de surcoût)
- **Orientations** : Prudent Horizon Retraite, Équilibre Horizon Retraite, Dynamique Horizon Retraite (3 orientations)
- **Principe** : sécurisation progressive de l'épargne à mesure que la retraite approche — arbitrage automatique vers le fonds euros
- **Supports** : sélectionnés par Abeille Retraite Professionnelle

### Cumul des modes de gestion

- **Possible** : gestion libre + gestion sous mandat + gestion évolutive (toute combinaison)
- **Changement** : gratuit, à tout moment
...
- **Transfert entrant** : géré par Lucya (le client fournit les informations de l'ancien contrat, Lucya contacte l'assureur) ; délai max 2 mois
...
- **App mobile** : non
- **Contact** :
  - Téléphone : 01 44 76 87 60
  - Email : contact@lucya.com
  - Formulaire de contact : oui
  - Courrier : 13 rue d'Uzès, 75002 Paris
  - Chat : non
...
- **Note globale** : 3,98/5
- **Points forts** :
  - Accessible dès 500 EUR, versements programmés dès 50 EUR/mois
  - 0 % frais de versement et 0 % frais d'arbitrage
...
- **Points faibles** :
  ...
  - Peu d'avis clients (15 avis)
  - ETF non utilisés en gestion pilotée
- **Services complémentaires** : assurance-vie (Lucya Abeille), PEA assurantiel, contrat de capitalisation, SCPI (via d'autres contrats)

## Sources

- [S'investir — Comparatif PER](https://simulateurs.sinvestir.fr/les-comparateurs/per)
- [Assurancevie.com — Lucya Abeille PER (ex Evolution PER)](https://www.assurancevie.com/nos-contrats/evolution-per/)
- [Assurancevie.com — Lucya Abeille PER en 10 points](https://www.assurancevie.com/nos-contrats/evolution-per-en-10-points.html)
- [Assurancevie.com — Liste des supports](https://www.assurancevie.com/asv/nos-contrats/lucya-abeille-per/liste-supports)
- [Assurancevie.com — PDF liste des supports financiers (25/11/2025)](https://www.assurancevie.com/assets/files/web/documents/per/evolution_vie_per/liste_supports_financiers.pdf)
- [Assurancevie.com — Supports immobiliers](https://www.assurancevie.com/nos-contrats/zoom-sur-le-support-immobilier-d-evolution-per.html)
