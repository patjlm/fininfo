...
> PER individuel assurantiel distribué par Goodvest, assuré par Generali.
> Premier PER en gestion pilotée 100 % ISR, aligné sur l'Accord de Paris.
...
- **Frais des fonds sous-jacents** : ~0,40 % / an en moyenne
- **Total tout compris** : 1,55 % à 1,75 % / an selon le profil
- **Frais sur encours de rente** : 2 %
- **Rétrocessions** : aucune (fonds en parts nettes uniquement)
- **Note frais** : 3/5
...
- **Condition si versement initial 300-999 EUR** : mise en place obligatoire de versements programmés (minimum 50 EUR / mois)
- **Condition si versement initial >= 1 000 EUR** : alimentation libre sans contrainte de versements programmés
- **Versements libres minimum** : 300 EUR [à vérifier]
...
- **Arbitrage minimum** : non applicable (gestion déléguée, arbitrages réalisés par Goodvest)
- **Frais d'arbitrage** : 0 %
...
| Nom | ISIN | Catégorie | SFDR |
|---|---|---|---|
| Mirova Europe Environmental Equity Fund N | LU0914733646 | Actions Europe environnement | Article 9 |
| M Climate Solutions C (Montpensier Finance) | FR0013446812 | Actions Solutions climatiques | Article 9 |
...
| Nom | ISIN | Catégorie |
|---|---|---|
| Goodvest Septembre 2024 | FR3CIBFS1125 | Produit structuré à impact |
| Goodvest Février 2025 | FR001400T803 | Produit structuré à impact |
| Goodvest Juin 2025 | FR001400X9Q3 | Produit structuré à impact |
| Goodvest Altitude Juin 2025 | FR001400YL43 | Produit structuré à impact |
...
- **Chat** : non
- **Courrier** : non
- **Ergonomie** : ergonomique et intuitive
- **Note SAV** : 4,8/5
...
- [Goodvest -- Page produit PER](https://www.goodvest.fr/le-per-goodvest)
- [Goodvest -- Tarifs](https://www.goodvest.fr/tarifs)
- [Goodvest -- Transfert PER](https://www.goodvest.fr/transfert-per)
