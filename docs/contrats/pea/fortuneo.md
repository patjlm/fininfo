...
> PEA proposé par Fortuneo (France), filiale du Crédit Mutuel Arkéa.
...
- **Type de gestion** : libre, gestion sous mandat
- **PEA classique** : oui
- **PEA-PME** : oui
- **PEA Jeunes** : non
- **Dépôt initial minimum** : 100 EUR
...
- **Sans conditions** d'encours ou de nombre de passages d'ordres
- **3 formules disponibles** :

### Tarif Starter

- 0 EUR pour le 1er ordre du mois (inférieur ou égal à 500 EUR)
- 0,35 % par ordre au-delà

### Tarif Progress

- 4,90 EUR par ordre inférieur ou égal à 3 000 EUR
- 0,15 % par ordre supérieur à 3 000 EUR

### Tarif Trader Pro

- 9,50 EUR par ordre inférieur ou égal à 10 000 EUR
- 0,10 % par ordre supérieur à 10 000 EUR

- **Frais de change** : aucun
- **Frais divers** :
  - Clôture : 85 EUR (hors clôture en cas de transfert)
  - Changement de formule : 60 EUR
...
- **OPC** : plus de 1 800 fonds (Sicav, FCP) à frais d'entrée négociés de 0 à 1 %
- **Fractions d'actions** : non
- **Investissement programmé (DCA)** : non
- **Plateforme de trading** : Live Trader (plateforme de trading et d'analyse technique), accès à TradingView, graphiques interactifs, analyses theScreener, alertes SMS/mail sur cours, listes personnalisées
- **Portefeuilles Types Actions** : offre de suivi de portefeuilles thématiques à 8 EUR/mois [à vérifier]
...
- **Montant minimum** : 30 000 EUR
- **Gestionnaire** : Arkéa Asset Management (Crédit Mutuel Arkéa)
- **Supports** : OPC (actions, obligations, monétaires) éligibles au PEA
- **Frais** :
  - Mise en place : 0 EUR
  - Changement de profil : 0 EUR
  - Résiliation : 0 EUR
  - Commission de performance : 12 % de la performance positive semestrielle (rien en cas de performance négative)
...
- **Test SAV** : environ 10 minutes d'attente (source : S'investir)
...
- **Points forts** :
  - Frais de courtage très compétitifs (1er ordre gratuit chaque mois en Starter)
  - 0 EUR de droits de garde
  - Banque en ligne complète (AV, PER, CTO, compte courant)
  - Outils de trading avancés (Live Trader, TradingView, alertes)
  - Plus de 1 800 fonds à frais d'entrée négociés
...
- **Points faibles** :
  ...
  - Pas de PEA Jeunes
  - Gestion sous mandat uniquement dynamique, seuil élevé (30 000 EUR)
  - Frais de clôture de 85 EUR
...
- [Fortuneo — PEA](https://www.fortuneo.fr/bourse/plan-epargne-actions)
