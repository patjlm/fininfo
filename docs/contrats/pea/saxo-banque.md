...
- **Pays / régulation** : Danemark — autorité de régulation danoise (Finanstilsynet) ; succursale enregistrée en France auprès de l'ACPR
- **Domiciliation du compte PEA** : France
...
- **Grille tarifaire indicative (profil Classic)** :
  - Ordre de 100 EUR : 0,50 EUR (plafond PACTE 0,50 % < minimum 2 EUR)
  - Ordre de 500 EUR : 2 EUR (minimum appliqué)
...
- **Transfert PEA remboursé** : 100 % des frais de transfert entrant remboursés (max. 150 EUR) — du 06/01/2025 au 31/12/2026
- **OPCVM** : 0 EUR de frais de courtage sur les fonds (achat et vente)
...
- **OPCVM / Fonds** : disponibles, 0 EUR de frais de courtage
- **Fractions d'actions** : non
- **Investissement programmé (DCA)** : non disponible sur PEA classique — un Plan Epargne Programmé Saxo (PEPS) existe mais concerne le compte-titres
- **Plateforme de trading** : SaxoInvestor (simple, pour débutants) et SaxoTrader (avancée, pour investisseurs expérimentés) — application mobile disponible
- **Temps réel Euronext** : gratuit
- **Outils** : screeners, listes de favoris, différents types d'ordres, actualités et inspirations, tableau de bord personnalisable
- **Note produits** : 3,5/5
...
- **Déclaration de compte étranger** : non (compte PEA domicilié en France)
- **IFU fourni** : oui
- **Note propriété** : 5/5
...
- **Niveaux de compte** : Classic (par défaut), Platinum, VIP — tarifs dégressifs selon l'activité
- **CTO ouvert automatiquement** : un compte-titres ordinaire est ouvert automatiquement en complément du PEA
- **Offre 70 actions sans frais** : réservée aux nouveaux PEA (ouverture ou transfert) — non cumulable pour les clients ayant déjà un PEA Saxo au 23/02/2026
- **ETF Amundi sans frais** : frais d'achat uniquement — les frais de vente restent facturés — positions non transférables pendant 6 mois
- **Introduction en bourse (IPO)** : accès aux introductions en bourse disponibles
- **Prêt de titres (stock lending)** : disponible (revenu complémentaire potentiel)
...
- **Contact** : téléphone (01 78 94 56 40), email (contact@saxobanque.fr)
- **Chat** : non
- **Courrier** : non
- **Test SAV** : attente d'une bonne vingtaine de minutes
- **Programme fidélité** : Saxo Rewards + Saxo Elite (service exclusif pour investisseurs actifs ou forts encours)
- **Note SAV** : 3,5/5
...
- **Note globale** : 4,12/5
- **Points forts** :
  - Courtier solide avec + de 30 ans d'expérience (groupe Saxo Bank, Copenhague 1992)
  - Frais de courtage compétitifs (0,08 %, min. 2 EUR) et offres promotionnelles attractives (70 actions sans frais, ETF Amundi gratuits)
  - Propriété directe des titres, IFU fourni, compte domicilié en France — pas de déclaration de compte étranger
  - Large gamme de marchés européens accessibles
  - Deux plateformes adaptées à différents profils (débutant / expert)
