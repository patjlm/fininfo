...
Wiki des produits financiers français.

## Catégories

- [Enveloppes d'investissement](enveloppes/README.md) — 11 fiches (Livret A, PEA, assurance vie, PER, CTO, SCPI, etc.)
- [Contrats](contrats/) — 72 fiches de contrats par catégorie :
...
- [Actifs](actifs/README.md) — 630 fiches (604 ETF, 20 SCPI, 5 OPCVM, 1 SC)
- [Institutions](institutions/README.md) — banques, courtiers, assureurs _(à venir)_
...
- Date de dernière mise à jour indiquée dans chaque section — les données peuvent devenir obsolètes
